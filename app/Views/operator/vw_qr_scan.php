...
<div class="container-fluid">
    ...
    <div class="card overflow-hidden">
        <div class="card-body p-0">
            <img src="<?= base_url('assets/images/backgrounds/profilebg.jpg'); ?>" class="img-fluid" alt="Profile Background">
        ...
        function startCamera() {
            ...
            Html5Qrcode.getCameras()
                .then(devices => {
                    ...
                    qrScanner.start(
                        cameraId,
                        { facingMode: "environment",fps: 10, qrbox: { width: 150, height: 150 } },
                        onQrCodeScanned,
                        onScanError
                    ).catch(err => {
